...
def flame_clustered():
    ...
    return cluster.cluster(region_partitioned_split_data=regions_data, min_cluster_size=20, min_samples=20, cluster_method="leaf", allow_single_cluster=False, drop_ungrouped=True)
