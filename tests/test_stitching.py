...
def test_centers(a3_clustered, a3_centers):
    actual = stitching.get_all_centers(
        ...
        split_columns=["x", "y"])[["group", "x", "y", "N"]].set_index("group", drop=True)
...
def test_cut_misplaced_clusters(a3_centers, a3_stitch_regions):
    ...
    actual = stitching.cut_misplaced_clusters(a3_centers, stitch_regions=a3_stitch_regions, split_columns=["x", "y"])
